...
;!function() {
    ...
    var e = window.layui && layui.define
        ...
        ,tData = []
        , T = function(e) {
        var t = this,isC=false;
        for (var jl=0;jl<tData.length;jl++) {
            if (e.elem == tData[jl]) {
                isC=true;
                break;
            }
    ...
    C.prototype = [],
        ...
        T.prototype.init = function() {
           ...
           //     e.elemID = "layui-laydate" + t.elem.attr("lay-key"),
                e.elemID = "layui-laydate" + this.index,
            (t.show || a) && e.render(),
            a || e.events(),
        ...
        T.prototype.limit = function(e, t, n, a) {
            var i, r = this, o = r.config, l = {}, d = o[n > 41 ? "endDate" : "dateTime"], c = w.extend({}, d, t || {}),nowDate;
            return w.each({
                now: c,
                min: o.min,
                max: o.max
            ...
            nowDate = l.now?new Date(l.now).getDate():0,
                i = l.now < l.min || l.now > l.max || (nowDate>r.config.disableData),
